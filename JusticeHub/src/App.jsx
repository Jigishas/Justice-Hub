          ...
          <div>
            <Tabs defaultValue="articles" className="w-full mt-10">
              <TabsList className="flex justify-center flex-wrap gap-3 mb-8 bg-white dark:bg-[#2a4d69] rounded-xl p-3 shadow-md border border-[#e7eff6] dark:border-[#4b86b4] backdrop-blur-sm">
                ...
                <TabsTrigger value="videos" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#4b86b4] data-[state=active]:text-blue-500 data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#2c5aa0] data-[state=active]:scale-105">Videos</TabsTrigger>
                <TabsTrigger value="podcasts" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#2a4d69] data-[state=active]:text-blue-500 data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#1a2a3a] data-[state=active]:scale-105">Podcasts</TabsTrigger>
                <TabsTrigger value="books" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#28a745] data-[state=active]:text-blue-500 data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#1e7e34] data-[state=active]:scale-105">Books</TabsTrigger>
