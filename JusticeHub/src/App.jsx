      ...
      <section id="educational-resources" className="bg-gradient-to-br from-[#e7eff6] to-[#d4e4f7] py-16 shadow-inner">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="articles" className="w-full mt-10">
            <TabsList className="flex justify-center flex-wrap gap-3 mb-8 bg-white rounded-xl p-3 shadow-md border border-[#e7eff6] backdrop-blur-sm">
              <TabsTrigger value="articles" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 text-gray-800 hover:bg-gray-300 hover:scale-105 data-[state=active]:bg-[#e74c3c] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#c0392b] data-[state=active]:scale-105">Articles</TabsTrigger>
              <TabsTrigger value="videos" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 text-gray-800 hover:bg-gray-300 hover:scale-105 data-[state=active]:bg-[#4b86b4] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#2c5aa0] data-[state=active]:scale-105">Videos</TabsTrigger>
              <TabsTrigger value="podcasts" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 text-gray-800 hover:bg-gray-300 hover:scale-105 data-[state=active]:bg-[#2a4d69] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#1a2a3a] data-[state=active]:scale-105">Podcasts</TabsTrigger>
              <TabsTrigger value="books" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 text-gray-800 hover:bg-gray-300 hover:scale-105 data-[state=active]:bg-[#28a745] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#1e7e34] data-[state=active]:scale-105">Books</TabsTrigger>
              <TabsTrigger value="toolkits" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 text-gray-800 hover:bg-gray-300 hover:scale-105 data-[state=active]:bg-[#fd7e14] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#d8590c] data-[state=active]:scale-105">Toolkits</TabsTrigger>
            </TabsList>
