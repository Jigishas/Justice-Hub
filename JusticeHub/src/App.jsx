...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f9f9f9] dark:bg-[#0f0f0f] text-[#333] dark:text-[#e7eff6] transition-colors">
      {/* Header */}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <input
              ...
              className="flex-1 p-4 rounded-l bg-white text-[#333] focus:outline-none focus:ring-2 focus:ring-[#e74c3c] transition-all"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              onKeyPress={(e) => e.key === 'Enter' && handleSearch()}
            />
            <Button
              className="rounded-l-none bg-[#e74c3c] hover:bg-[#c0392b] text-white px-6 transition-all hover:scale-105"
            ...
            {(filteredActions.length > 0 ? filteredActions : actionsData).map((action, index) => (
              ...
              >
                <Card className="text-center p-8 flex flex-col items-center shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-[#2a4d69] border-0 h-full">
                  ...
                  <h3 className="font-bold text-lg text-[#2a4d69] dark:text-white mb-2">{action.title}</h3>
              ...
              >
                <Card className="overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-[#2a4d69] border-0">
                  ...
                  <CardContent className="p-5">
                    <h3 className="font-bold text-lg text-[#2a4d69] dark:text-white mb-2">{issue.title}</h3>
                    <p className="text-sm text-[#666] dark:text-[#e7eff6] mb-4">{issue.desc}</p>
                    <Progress value={percents[issue.index]} className="mb-2 h-2 bg-gray-200 dark:bg-gray-700" />
                    <div className="flex justify-between text-xs text-[#666] dark:text-[#e7eff6]">
          ...
          >
            <Tabs defaultValue="articles" className="w-full mt-10">
              <TabsList className="flex justify-center flex-wrap gap-3 mb-8 bg-white dark:bg-[#2a4d69] rounded-xl p-3 shadow-md border border-[#e7eff6] dark:border-[#4b86b4] backdrop-blur-sm">
                <TabsTrigger value="articles" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#e74c3c] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#c0392b] data-[state=active]:scale-105">Articles</TabsTrigger>
                <TabsTrigger value="videos" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#4b86b4] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#2c5aa0] data-[state=active]:scale-105">Videos</TabsTrigger>
                <TabsTrigger value="podcasts" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#2a4d69] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#1a2a3a] data-[state=active]:scale-105">Podcasts</TabsTrigger>
                <TabsTrigger value="books" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#28a745] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#1e7e34] data-[state=active]:scale-105">Books</TabsTrigger>
                <TabsTrigger value="toolkits" className="px-6 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-[#1a2a3a] text-gray-800 dark:text-[#e7eff6] hover:bg-gray-300 dark:hover:bg-[#2a4d69] hover:scale-105 data-[state=active]:bg-[#fd7e14] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:border-2 data-[state=active]:border-[#d8590c] data-[state=active]:scale-105">Toolkits</TabsTrigger>
              </TabsList>
                  ...
                  >
                    <Card className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white dark:bg-[#2a4d69] rounded-xl overflow-hidden">
                      <CardContent className="p-6">
                        ...
                        <h3 className="font-bold text-xl text-[#2a4d69] dark:text-white mb-3">{article.title}</h3>
                        <p className="text-sm text-[#666] dark:text-[#e7eff6] mb-5 leading-relaxed">{article.desc}</p>
                        <Button asChild variant="destructive" className="w-full py-3 rounded-lg font-medium transition-all">
                  ...
                  >
                    <Card className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white dark:bg-[#2a4d69] rounded-xl overflow-hidden">
                      <CardContent className="p-6">
                        ...
                        <h3 className="font-bold text-xl text-[#2a4d69] dark:text-white mb-3">{video.title}</h3>
                        <p className="text-sm text-[#666] dark:text-[#e7eff6] mb-5 leading-relaxed">{video.desc}</p>
                        <Button asChild variant="destructive" className="w-full py-3 rounded-lg font-medium transition-all">
                  ...
                  >
                    <Card className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white dark:bg-[#2a4d69] rounded-xl overflow-hidden">
                      <CardContent className="p-6">
                        ...
                        <h3 className="font-bold text-xl text-[#2a4d69] dark:text-white mb-3">{podcast.title}</h3>
                        <p className="text-sm text-[#666] dark:text-[#e7eff6] mb-5 leading-relaxed">{podcast.desc}</p>
                        <Button asChild variant="destructive" className="w-full py-3 rounded-lg font-medium transition-all">
                  ...
                  >
                    <Card className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white dark:bg-[#2a4d69] rounded-xl overflow-hidden">
                      <CardContent className="p-6">
                        ...
                        <h3 className="font-bold text-xl text-[#2a4d69] dark:text-white mb-3">{book.title}</h3>
                        <p className="text-sm text-[#666] dark:text-[#e7eff6] mb-5 leading-relaxed">{book.desc}</p>
                        <Button asChild variant="destructive" className="w-full py-3 rounded-lg font-medium transition-all">
                          <a href={book.index === 0 ? "https://www.amazon.com/New-Jim-Crow-Incarceration-Colorblindness/dp/1595586431" : book.index === 1 ? "https://bookshop.org/p/books/how-to-be-an-antiracist-ibram-x-kendi/521ef65d5c2268ca?ean=9780525509288&next=t&next=t" : "https://bookshop.org/p/books/caste-the-origins-of-our-discontents-isabel-wilkerson/ba07006a708c5070?ean=9780593230251&next=t&next=t"} target="_blank" rel="noopener noreferrer">View Book</a>
                        </Button>
                      </CardContent>
                    </Card>
                  </motion.div>
              ...
              >
                {(filteredResources.toolkits.length > 0 ? filteredResources.toolkits : resourcesData.toolkits).map((toolkit, index) => (
                  ...
                  >
                    <Card className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white dark:bg-[#2a4d69] rounded-xl overflow-hidden">
                      <CardContent className="p-6">
                        <div className="w-12 h-12 bg-[#fd7e14] rounded-full flex items-center justify-center mb-4">
                          <FaTools className="text-white text-xl" />
                        </div>
                        <h3 className="font-bold text-xl text-[#2a4d69] dark:text-white mb-3">{toolkit.title}</h3>
                        <p className="text-sm text-[#666] dark:text-[#e7eff6] mb-5 leading-relaxed">{toolkit.desc}</p>
                        <Button asChild variant="destructive" className="w-full py-3 rounded-lg font-medium transition-all">
                          <a href={toolkit.index === 0 ? "https://commonslibrary.org/tools-for-organising/" : toolkit.index === 1 ? "https://mobilisationlab.org/resources/" : "https://www.unicef.org/evaluation/files/Advocacy_Toolkit.pdf"} target="_blank" rel="noopener noreferrer">Download Toolkit</a>
                        </Button>
                      </CardContent>
                    </Card>
                  </motion.div>
